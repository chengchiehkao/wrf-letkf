...
wrfletkf.exe: mod_derivedtype.o mod_basicutility.o mod_ioutility.o mod_systemutility.o mod_math.o mod_assimilationutility.o 
	$(FC) $(optimization_flag) $(openmp_flag) $(netcdf_flag) *.o main_WRFLETKF.f90 $(lapack_path) \
		-o wrfletkf.exe
