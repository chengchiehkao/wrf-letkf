...
type systemParameter
    ...
    character(len=10),pointer,dimension(:) :: varList_sound=>null() , varList_airep=>null() , varList_synop=>null() , varList_amv=>null() , varList_gpsro=>null() , varList_airs=>null() ,   &
                                              varList_quikscat=>null() , varList_ascat=>null() , varList_iasi=>null() , varList_oscat=>null() , varList_windsat=>null() , varList_cygnss=>null()
    logical,pointer,dimension(:) :: use_varList_sound=>null() , use_varList_airep=>null() , use_varList_synop=>null() , use_varList_amv=>null() , use_varList_gpsro=>null() , use_varList_airs=>null() ,  &
                                     use_varList_quikscat=>null() , use_varList_ascat=>null() , use_varList_iasi=>null() , use_varList_oscat=>null() , use_varList_windsat=>null() , use_varList_cygnss=>null()
...
type backgroundInfo
    real(kind=8),pointer,dimension(:,:)   :: mu=>null() , u10=>null() , v10=>null() , ws10=>null()
