...
logical :: use_sound , use_synop , use_amv , use_gpsro , use_airs
integer,parameter :: defaultVarListSize=10
character(len=10),dimension(defaultVarListSize) :: varList_sound , varList_synop , varList_amv , varList_gpsro , varList_airs
logical,dimension(defaultVarListSize) :: use_varList_sound , use_varList_synop , use_varList_amv , use_varList_gpsro , use_varList_airs
integer :: varListSize_sound , varListSize_synop , varListSize_amv , varListSize_gpsro , varListSize_airs
...
namelist /use_observation/ use_sound,use_synop,use_amv,use_gpsro,use_airs
namelist /varList_observation/ varList_sound,varList_synop,varList_amv,varList_gpsro,varList_airs
namelist /use_varList_observation/ use_varList_sound,use_varList_synop,use_varList_amv,use_varList_gpsro,use_varList_airs
